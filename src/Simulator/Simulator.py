...
class Simulator:
    ...
    def run(self, init=None, control=None, parameter=None, Linit=None):
        ...
        sim = SimulationTask1(n_agents,actualL,self.dt , self.masVel, agents_list, timesteps, parameter)
        #save initial state
...
class Simulator2(Simulator):
    ...
    def run(self, init= None, control=None, parameter=None, Linit=None):
        ...
        sim = SimulationTask2(n_agents,actualL,self.dt , self.masVel, agents_list, timesteps, parameter)
        #save initial state
        sim.saveInitialState()
