...
from com_network import Sync, ComNetLnoSensing
import torch
...
if __name__ == '__main__':
    ...
    sim = Simulator2(timesteps,N,L,mas_vel, initMode=UniformInit())  # if define a min_range and a max_range ti resemble the real situation.
